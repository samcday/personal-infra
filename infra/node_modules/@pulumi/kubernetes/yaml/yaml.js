...
class ConfigFile extends CollectionComponentResource {
    ...
    constructor(name, config, opts) {
        ...
        const transformations = (_b = (_a = config) === null || _a === void 0 ? void 0 : _a.transformations, (_b !== null && _b !== void 0 ? _b : []));
        if ((_c = config) === null || _c === void 0 ? void 0 : _c.skipAwait) {
...
/** @ignore */ function parse(config, opts) {
    ...
    const transformations = (_a = config.transformations, (_a !== null && _a !== void 0 ? _a : []));
    if (config.skipAwait) {
        transformations.push(skipAwait);
    }
