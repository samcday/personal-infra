...
class Secret extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            inputs["data"] = ((_a = args) === null || _a === void 0 ? void 0 : _a.data) ? pulumi.secret(args.data) : undefined;
            inputs["immutable"] = args ? args.immutable : undefined;
            inputs["kind"] = "Secret";
            inputs["metadata"] = args ? args.metadata : undefined;
            inputs["stringData"] = ((_b = args) === null || _b === void 0 ? void 0 : _b.stringData) ? pulumi.secret(args.stringData) : undefined;
