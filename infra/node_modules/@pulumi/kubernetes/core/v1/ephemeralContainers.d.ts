 ...
 */
export declare class EphemeralContainers extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EphemeralContainers;
    /**
     * Returns true if the given object is an instance of EphemeralContainers.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EphemeralContainers;
    /**
     ...
     */
    readonly ephemeralContainers: pulumi.Output<outputs.core.v1.EphemeralContainer[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    readonly kind: pulumi.Output<"EphemeralContainers">;
